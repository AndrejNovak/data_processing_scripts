...
plt.savefig(folder_figures + 'histogram_1_energy.png', dpi=mydpi, transparent=True, bbox_inches="tight", pad_inches=0.01)
...
plt.legend(loc='upper right')
plt.savefig(folder_figures + 'histogram_4_LET.png', dpi=mydpi, transparent=True, bbox_inches="tight", pad_inches=0.01)
...
plt.legend(loc='upper right')
plt.savefig(folder_figures + 'histogram_5_Epx.png', dpi=mydpi, transparent=True, bbox_inches="tight", pad_inches=0.01)
"""
