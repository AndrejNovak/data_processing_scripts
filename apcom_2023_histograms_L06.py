...
PathOut = r'Q:\DPE_andrej_data_output\2023_02_24_Am241_time_spectra\Apcom_2023\temporal_stability\L06_tpx3\\'
tickfnt = 14
...
for i in range(len(subdirectories)):
    ...
    if os.path.isfile(PathOut + 'histograms\\L06_tpx3_filtered_data'+str(i)+'.txt'):
        filtered_data = np.loadtxt(PathOut + 'histograms\\L06_tpx3_filtered_data'+str(i)+'.txt')
    else:
        ...
        np.savetxt(PathOut + 'histograms\\L06_tpx3_filtered_data'+str(i)+'.txt', filtered_data)
