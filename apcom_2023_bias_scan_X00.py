...
PathIn = r'Q:\DPE_andrej_data_output\2023_02_24_Am241_time_spectra\bias_scan\X00_tpx2'
PathOut = r'Q:\DPE_andrej_data_output\2023_02_24_Am241_time_spectra\Apcom_2023\bias_scan\X00_tpx2\\'
tickfnt = 14
...
for i in range(len(subdirectories)):
    ...
    if os.path.isfile(PathOut + 'histograms\\X00_tpx2_filtered_data'+str(i)+'V.txt'):
        filtered_data = np.loadtxt(PathOut + 'histograms\\X00_tpx2_filtered_data'+str(i)+'V.txt')
    else:
        ...
        np.savetxt(PathOut + 'histograms\\X00_tpx2_filtered_data'+str(i)+'V.txt', filtered_data)
