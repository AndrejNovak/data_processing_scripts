...
for idx2, var2 in enumerate(all_paths):
    ...
    for idx, var in enumerate(folder_data):
        ...
        range_energy_max, range_energy_step = 20000, 100    # parameter Energy 4 max(elist_data[:,4])
        range_height_max, range_height_step = 20000, 100    # parameter Height 8 max(elist_data[:,8])
        range_size_max, range_size_step = max(elist_data[:,7]), 1    # parameter Size 7
        ...
        print(f'Total number of iterations is {int(range_energy_max / range_energy_step) + int(range_height_max / range_height_step) + int(range_size_max / range_size_step) + int(range_linearity_max / (range_linearity_step * 0.1)) + int(range_length_max / range_length_step)}')
        ...
        for iter_energy in range(0, int(range_energy_max), range_energy_step):
            ...
            SubfolderPath = 'E_' + str(energy_parameter)
        ...
        for iter_height in range(0, int(range_height_max), range_height_step):
            ...
            SubfolderPath = 'Height_' + str(height_parameter)
            FolderOutPath = FolderOut + var + '\\' + SubfolderPath + '\\'
        ...
        for iter_size in range(0, int(range_size_max), range_size_step):
            ...
            SubfolderPath = 'Size_' + str(size_parameter)
            FolderOutPath = FolderOut + var + '\\' + SubfolderPath + '\\'
        ...
        for iter_linearity in range(0, int(range_linearity_max) * 10, range_linearity_step):
            ...
            SubfolderPath = 'Linearity_' + str(round(linearity_parameter,1))
            FolderOutPath = FolderOut + var + '\\' + SubfolderPath + '\\'
        ...
        for iter_length in range(0, int(range_length_max), range_length_step):
            ...
            SubfolderPath = 'Length_' + str(length_parameter)
            FolderOutPath = FolderOut + var + '\\' + SubfolderPath + '\\'
